...
module.exports = {
	...
	execute(message, args) {
		const helpEmbed = {
			color: 0x006699,
			title: 'Utility Commands List',
			author: {
				name: 'Prime',
				icon_url: client.user.displayAvatarURL,
			},
			description: `Server Prefix: **${prefix}**`,
			fields: [
				{
					name: '**Command**',
					value: '**prefix\nhelp\nuserinfo\nserverinfo\nroleinfo**',
				...
				},
				{
					...
					value: 'Allows change of server prefix.\nDisplays command categories.\nDisplays general information of specified user.\nDisplayes general server information.\nDisplays information pertaining to specified role.',
					inline: true,
				},
			],
			timestamp: new Date(),
